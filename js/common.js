...
$("input[type='file']").change(function(){
	...
	$(".btn-main_video").modalVideo();
	$(".review-video__image").modalVideo();
	...
	$(".item-package__title").click(function() {
		$(this).parent().toggleClass("active");
		$(this).siblings(".item-package__content").slideToggle(200);
	});
	...
	{
		if ($(window).width() < 992) { 
			$(".list-menu__haschild > a").click(function(e) {
		e.preventDefault();
		$(this).parent().toggleClass("active");
		$(this).siblings().slideToggle(200);
	});
	...
	{
		if ($(window).width() > 992) { 
			$(".list-menu > li").on( "mouseover", function() {
	...
	$(window).resize(function () {
		if ($(window).width() < 992) {
			$('.row_about').slick('refresh');
			$('.row_team').slick('refresh');
		}
	})
	...
	*/
	...
	$(".item-service__head").click(function() {
		$(this).parent().toggleClass("active");
		$(this).siblings(".item-service__content").slideToggle(200);
	});
